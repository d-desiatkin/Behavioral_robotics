...
public:
	...
	// Whether it is a first iteration of network
	bool *Dmitrii_start_learning;
	// Store pts on prev net output
	float **Dmitrii_ptr_cact_prev;
	// Store pts on prev net input
	float **Dmitrii_ptr_cobs_prev;
	int Dmitrii_net_number;
